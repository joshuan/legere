...
export const ERROR_MESSAGE_KEYS: Record<ErrorCode | 'NETWORK', string> = {
  ...
  RECEIPT_NOT_FOUND: 'errors.codes.RECEIPT_NOT_FOUND',
  ...
  CATALOGUE_FULL: 'errors.codes.CATALOGUE_FULL',
  DOCUMENT_DUPLICATE: 'errors.codes.DOCUMENT_DUPLICATE',
  RECEIPT_DUPLICATE: 'errors.codes.RECEIPT_DUPLICATE',
  ARCHIVE_KIND_CONFLICT: 'errors.codes.ARCHIVE_KIND_CONFLICT',
  ...
  DOCUMENT_LAST_PAGE: 'errors.codes.DOCUMENT_LAST_PAGE',
  DOCUMENT_WOULD_HAVE_NO_READERS: 'errors.codes.DOCUMENT_WOULD_HAVE_NO_READERS',
  DOCUMENT_TOO_MANY_FILES: 'errors.codes.DOCUMENT_TOO_MANY_FILES',
  FILE_ALREADY_IN_DOCUMENT: 'errors.codes.FILE_ALREADY_IN_DOCUMENT',
  DOCUMENT_CHANGED: 'errors.codes.DOCUMENT_CHANGED',
  FILE_READ_ELSEWHERE: 'errors.codes.FILE_READ_ELSEWHERE',
  ...
  RECEIPT_EXTRACTOR_NOT_CONFIGURED: 'errors.codes.RECEIPT_EXTRACTOR_NOT_CONFIGURED',
  PROCESSING_SETTINGS_CHANGED: 'errors.codes.PROCESSING_SETTINGS_CHANGED',
  PROCESSING_APPLY_FAILED: 'errors.codes.PROCESSING_APPLY_FAILED',
  ...
  FILE_NOT_PDF: 'errors.codes.FILE_NOT_PDF',
