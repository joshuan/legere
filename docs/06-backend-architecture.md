...
| subjects | `ListSubjects`, `CreateSubject`, `UpdateSubject`ᴬ, `DeleteSubject`ᴬ, `MergeSubjects`ᴬ |
| subject kinds | `ListSubjectKinds`, `CreateSubjectKind`, `UpdateSubjectKind`ᴬ, `DeleteSubjectKind`ᴬ |
