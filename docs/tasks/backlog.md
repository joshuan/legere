...
- [ ] **M22.1 — A document type carries a schema, and the pipeline fills it**
...
- [ ] **M22.2 — The card says what was read off the paper**
...
- [ ] **M22.3 — Papers that belong together are linked, and cite each other**
